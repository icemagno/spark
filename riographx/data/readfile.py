...
## Par̢metros: 
## arquivo:  arquivo texto com a matriz de adjac̻ncia gerada pelo geng
## chave: string contendo os caracteres correspondentes 
## das fun̵̤es a serem geradas
##        -a   : n̼mero cromatico
##        -b   : n̼mero cromatico do grafo complementar
##        -c   : tamanho da maior clique
##        -d   : tamanho da maior clique do grafo complementar
##        -e k : k-̩simo maior grau do grafo
##        -f k : k-̩simo maior grau do grafo complementar
##
import getopt
