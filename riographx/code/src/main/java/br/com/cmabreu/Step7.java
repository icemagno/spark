...
public class Step7 implements Serializable {
	private static final long serialVersionUID = 1L;

	public JavaRDD<String> run( JavaRDD<String> graphs, String workDir, String showgScript ) {
		
		String external = workDir + "/" + showgScript;
